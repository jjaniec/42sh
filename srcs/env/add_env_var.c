...
/*   Updated: 2018/12/05 19:56:52 by jjaniec          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Copy name & entry value in new entry struct data string
*/

static void	cp_new_entry_data(t_env_entry *new_entry_struct, char *name, \
				char *entry_value)
{
	int				entry_name_len;
