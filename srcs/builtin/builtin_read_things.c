...
/*   Updated: 2018/11/10 20:46:10 by cyfermie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		_amdr(struct s_bltread *options, char **args, unsigned int *i,
														bool *fou)
{
	int janice;

	janice = _norme_mdr(2, options, args, i);
	if (janice == 2)
		*fou = true;
	else 
